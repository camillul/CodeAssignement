...
bool hos_interfaces__msg__p200_attachement_container_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._p200_attachement_container_state.P200AttachementContainerState", full_classname_dest, 82) == 0);
  }
  hos_interfaces__msg__P200AttachementContainerState * ros_message = _ros_message;
  {  // is_flipped
...
{
  /* NOTE(esteve): Call constructor of P200AttachementContainerState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._p200_attachement_container_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "P200AttachementContainerState");
