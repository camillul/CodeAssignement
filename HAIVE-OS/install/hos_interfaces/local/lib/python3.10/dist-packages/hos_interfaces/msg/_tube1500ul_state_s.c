...
bool hos_interfaces__msg__tube1500ul_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._tube1500ul_state.Tube1500ulState", full_classname_dest, 52) == 0);
  }
  hos_interfaces__msg__Tube1500ulState * ros_message = _ros_message;
  {  // is_flipped
...
{
  /* NOTE(esteve): Call constructor of Tube1500ulState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._tube1500ul_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tube1500ulState");
