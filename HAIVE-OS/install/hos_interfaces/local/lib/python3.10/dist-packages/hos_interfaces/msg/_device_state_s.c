...
bool hos_interfaces__msg__device_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._device_state.DeviceState", full_classname_dest, 44) == 0);
  }
  hos_interfaces__msg__DeviceState * ros_message = _ros_message;
  {  // is_connected
...
PyObject * hos_interfaces__msg__device_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._device_state");
