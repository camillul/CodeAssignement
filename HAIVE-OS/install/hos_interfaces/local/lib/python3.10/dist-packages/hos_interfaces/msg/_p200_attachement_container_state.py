...
class Metaclass_P200AttachementContainerState(type):
    """Metaclass of message 'P200AttachementContainerState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hos_interfaces.msg.P200AttachementContainerState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__p200_attachement_container_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__p200_attachement_container_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__p200_attachement_container_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__p200_attachement_container_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__p200_attachement_container_state
...
class P200AttachementContainerState(metaclass=Metaclass_P200AttachementContainerState):
    """Message class 'P200AttachementContainerState'."""
