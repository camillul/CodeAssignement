...
class Metaclass_P1000AttachementContainerState(type):
    """Metaclass of message 'P1000AttachementContainerState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hos_interfaces.msg.P1000AttachementContainerState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__p1000_attachement_container_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__p1000_attachement_container_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__p1000_attachement_container_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__p1000_attachement_container_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__p1000_attachement_container_state
...
class P1000AttachementContainerState(metaclass=Metaclass_P1000AttachementContainerState):
    """Message class 'P1000AttachementContainerState'."""
