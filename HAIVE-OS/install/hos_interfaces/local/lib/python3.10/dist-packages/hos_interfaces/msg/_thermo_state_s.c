...
bool hos_interfaces__msg__thermo_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._thermo_state.ThermoState", full_classname_dest, 44) == 0);
  }
  hos_interfaces__msg__ThermoState * ros_message = _ros_message;
  {  // is_connected
...
{
  /* NOTE(esteve): Call constructor of ThermoState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._thermo_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ThermoState");
