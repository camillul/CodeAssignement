...
bool hos_interfaces__msg__haive_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._haive_state.HaiveState", full_classname_dest, 42) == 0);
  }
  hos_interfaces__msg__HaiveState * ros_message = _ros_message;
  {  // x_position
...
{
  /* NOTE(esteve): Call constructor of HaiveState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._haive_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HaiveState");
