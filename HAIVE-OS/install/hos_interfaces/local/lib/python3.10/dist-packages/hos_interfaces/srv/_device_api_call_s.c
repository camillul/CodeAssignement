...
bool hos_interfaces__srv__device_api_call__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.srv._device_api_call.DeviceAPICall_Request", full_classname_dest, 57) == 0);
  }
  hos_interfaces__srv__DeviceAPICall_Request * ros_message = _ros_message;
  {  // device_id
...
{
  /* NOTE(esteve): Call constructor of DeviceAPICall_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.srv._device_api_call");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DeviceAPICall_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool hos_interfaces__srv__device_api_call__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.srv._device_api_call.DeviceAPICall_Response", full_classname_dest, 58) == 0);
  }
  hos_interfaces__srv__DeviceAPICall_Response * ros_message = _ros_message;
  {  // is_valid
...
{
  /* NOTE(esteve): Call constructor of DeviceAPICall_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.srv._device_api_call");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DeviceAPICall_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
