...
bool hos_interfaces__msg__typed_field__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._typed_field.TypedField", full_classname_dest, 42) == 0);
  }
  hos_interfaces__msg__TypedField * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of TypedField */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._typed_field");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TypedField");
