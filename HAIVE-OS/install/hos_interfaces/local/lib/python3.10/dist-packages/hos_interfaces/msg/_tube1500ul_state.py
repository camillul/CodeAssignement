...
class Metaclass_Tube1500ulState(type):
    """Metaclass of message 'Tube1500ulState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hos_interfaces.msg.Tube1500ulState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__tube1500ul_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__tube1500ul_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__tube1500ul_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__tube1500ul_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__tube1500ul_state
...
class Tube1500ulState(metaclass=Metaclass_Tube1500ulState):
    """Message class 'Tube1500ulState'."""
