...
bool hos_interfaces__msg__falcon_container_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._falcon_container_state.FalconContainerState", full_classname_dest, 63) == 0);
  }
  hos_interfaces__msg__FalconContainerState * ros_message = _ros_message;
  {  // is_flipped
...
{
  /* NOTE(esteve): Call constructor of FalconContainerState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._falcon_container_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FalconContainerState");
