...
bool hos_interfaces__msg__delta_haive_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._delta_haive_state.DeltaHaiveState", full_classname_dest, 53) == 0);
  }
  hos_interfaces__msg__DeltaHaiveState * ros_message = _ros_message;
  {  // x_position
    ...
    ros_message->x_position = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // y_position
    ...
    assert(PyLong_Check(field));
    ros_message->y_position = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // turntable_slot
    PyObject * field = PyObject_GetAttrString(_pymsg, "turntable_slot");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->turntable_slot = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // is_connected
...
{
  /* NOTE(esteve): Call constructor of DeltaHaiveState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._delta_haive_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DeltaHaiveState");
  ...
  {  // x_position
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->x_position);
    {
  ...
  {  // y_position
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->y_position);
    {
  ...
  {  // turntable_slot
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->turntable_slot);
    {
      int rc = PyObject_SetAttrString(_pymessage, "turntable_slot", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
