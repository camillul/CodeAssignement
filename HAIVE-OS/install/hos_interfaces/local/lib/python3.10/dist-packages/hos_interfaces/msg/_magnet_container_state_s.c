...
bool hos_interfaces__msg__magnet_container_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._magnet_container_state.MagnetContainerState", full_classname_dest, 63) == 0);
  }
  hos_interfaces__msg__MagnetContainerState * ros_message = _ros_message;
  {  // is_flipped
...
{
  /* NOTE(esteve): Call constructor of MagnetContainerState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._magnet_container_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MagnetContainerState");
