...
bool hos_interfaces__msg__base_haive_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._base_haive_state.BaseHAIVEState", full_classname_dest, 51) == 0);
  }
  hos_interfaces__msg__BaseHAIVEState * ros_message = _ros_message;
  {  // x_position
...
{
  /* NOTE(esteve): Call constructor of BaseHAIVEState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._base_haive_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseHAIVEState");
