...
bool hos_interfaces__msg__connection_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._connection_info.ConnectionInfo", full_classname_dest, 50) == 0);
  }
  hos_interfaces__msg__ConnectionInfo * ros_message = _ros_message;
  {  // device_id
  ...
  {  // device_uid
    ...
    ros_message->device_uid = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // device_type
  ...
  {  // event_time_s
    PyObject * field = PyObject_GetAttrString(_pymsg, "event_time_s");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->event_time_s = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ConnectionInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._connection_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConnectionInfo");
  ...
  {  // device_uid
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->device_uid);
    {
  ...
  {  // event_time_s
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->event_time_s);
    {
      int rc = PyObject_SetAttrString(_pymessage, "event_time_s", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
