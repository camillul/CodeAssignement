...
class Metaclass_P200ContainerState(type):
    """Metaclass of message 'P200ContainerState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hos_interfaces.msg.P200ContainerState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__p200_container_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__p200_container_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__p200_container_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__p200_container_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__p200_container_state
...
class P200ContainerState(metaclass=Metaclass_P200ContainerState):
    """Message class 'P200ContainerState'."""
