...
bool hos_interfaces__msg__vortexer_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hos_interfaces.msg._vortexer_state.VortexerState", full_classname_dest, 48) == 0);
  }
  hos_interfaces__msg__VortexerState * ros_message = _ros_message;
  {  // rotation_speed
...
{
  /* NOTE(esteve): Call constructor of VortexerState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hos_interfaces.msg._vortexer_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VortexerState");
