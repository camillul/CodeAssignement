...
hos_interfaces__srv__DeviceCommand_Request__init(hos_interfaces__srv__DeviceCommand_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->function_name)) {
    hos_interfaces__srv__DeviceCommand_Request__fini(msg);
    return false;
  }
  // num_args
  // args
  ...
  hos_interfaces__srv__DeviceCommand_Request * output)
{
  ...
  // num_args
  output->num_args = input->num_args;
  // args
...
hos_interfaces__srv__DeviceCommand_Request__create()
{
  ...
  hos_interfaces__srv__DeviceCommand_Request * msg = (hos_interfaces__srv__DeviceCommand_Request *)allocator.allocate(sizeof(hos_interfaces__srv__DeviceCommand_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hos_interfaces__srv__DeviceCommand_Request));
  bool success = hos_interfaces__srv__DeviceCommand_Request__init(msg);
  if (!success) {
...
hos_interfaces__srv__DeviceCommand_Request__Sequence__init(hos_interfaces__srv__DeviceCommand_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__srv__DeviceCommand_Request * data = NULL;

  if (size) {
    data = (hos_interfaces__srv__DeviceCommand_Request *)allocator.zero_allocate(size, sizeof(hos_interfaces__srv__DeviceCommand_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hos_interfaces__srv__DeviceCommand_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hos_interfaces__srv__DeviceCommand_Request__fini(&data[i - 1]);
      }
...
hos_interfaces__srv__DeviceCommand_Request__Sequence__fini(hos_interfaces__srv__DeviceCommand_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hos_interfaces__srv__DeviceCommand_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__srv__DeviceCommand_Request__Sequence * array = (hos_interfaces__srv__DeviceCommand_Request__Sequence *)allocator.allocate(sizeof(hos_interfaces__srv__DeviceCommand_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hos_interfaces__srv__DeviceCommand_Request__Sequence__init(array, size);
  if (!success) {
...
hos_interfaces__srv__DeviceCommand_Request__Sequence__destroy(hos_interfaces__srv__DeviceCommand_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hos_interfaces__srv__DeviceCommand_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hos_interfaces__srv__DeviceCommand_Request__Sequence__are_equal(const hos_interfaces__srv__DeviceCommand_Request__Sequence * lhs, const hos_interfaces__srv__DeviceCommand_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hos_interfaces__srv__DeviceCommand_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hos_interfaces__srv__DeviceCommand_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hos_interfaces__srv__DeviceCommand_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hos_interfaces__srv__DeviceCommand_Request * data =
      (hos_interfaces__srv__DeviceCommand_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hos_interfaces__srv__DeviceCommand_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hos_interfaces__srv__DeviceCommand_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hos_interfaces__srv__DeviceCommand_Request__copy(
...
hos_interfaces__srv__DeviceCommand_Response__init(hos_interfaces__srv__DeviceCommand_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->error)) {
    hos_interfaces__srv__DeviceCommand_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__srv__DeviceCommand_Response * msg = (hos_interfaces__srv__DeviceCommand_Response *)allocator.allocate(sizeof(hos_interfaces__srv__DeviceCommand_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hos_interfaces__srv__DeviceCommand_Response));
  bool success = hos_interfaces__srv__DeviceCommand_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hos_interfaces__srv__DeviceCommand_Response__Sequence__init(hos_interfaces__srv__DeviceCommand_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__srv__DeviceCommand_Response * data = NULL;

  if (size) {
    data = (hos_interfaces__srv__DeviceCommand_Response *)allocator.zero_allocate(size, sizeof(hos_interfaces__srv__DeviceCommand_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hos_interfaces__srv__DeviceCommand_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hos_interfaces__srv__DeviceCommand_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hos_interfaces__srv__DeviceCommand_Response__Sequence__fini(hos_interfaces__srv__DeviceCommand_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hos_interfaces__srv__DeviceCommand_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__srv__DeviceCommand_Response__Sequence * array = (hos_interfaces__srv__DeviceCommand_Response__Sequence *)allocator.allocate(sizeof(hos_interfaces__srv__DeviceCommand_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hos_interfaces__srv__DeviceCommand_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hos_interfaces__srv__DeviceCommand_Response__Sequence__destroy(hos_interfaces__srv__DeviceCommand_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hos_interfaces__srv__DeviceCommand_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hos_interfaces__srv__DeviceCommand_Response__Sequence__are_equal(const hos_interfaces__srv__DeviceCommand_Response__Sequence * lhs, const hos_interfaces__srv__DeviceCommand_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hos_interfaces__srv__DeviceCommand_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hos_interfaces__srv__DeviceCommand_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hos_interfaces__srv__DeviceCommand_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hos_interfaces__srv__DeviceCommand_Response * data =
      (hos_interfaces__srv__DeviceCommand_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hos_interfaces__srv__DeviceCommand_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hos_interfaces__srv__DeviceCommand_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hos_interfaces__srv__DeviceCommand_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
