...
#ifndef HOS_INTERFACES__SRV__DETAIL__SERIALIZED_DEVICE_COMMAND__FUNCTIONS_H_
#define HOS_INTERFACES__SRV__DETAIL__SERIALIZED_DEVICE_COMMAND__FUNCTIONS_H_
...
/// Initialize srv/SerializedDeviceCommand message.
/**
...
/// Finalize srv/SerializedDeviceCommand message.
/**
...
/// Create srv/SerializedDeviceCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hos_interfaces__srv__SerializedDeviceCommand_Request__init().
...
/// Destroy srv/SerializedDeviceCommand message.
/**
 * It calls
 * hos_interfaces__srv__SerializedDeviceCommand_Request__fini()
...
/// Check for srv/SerializedDeviceCommand message equality.
/**
...
/// Copy a srv/SerializedDeviceCommand message.
/**
...
/// Initialize array of srv/SerializedDeviceCommand messages.
/**
...
/// Finalize array of srv/SerializedDeviceCommand messages.
/**
 * It calls
 * hos_interfaces__srv__SerializedDeviceCommand_Request__fini()
...
/// Create array of srv/SerializedDeviceCommand messages.
/**
 * It allocates the memory for the array and calls
 * hos_interfaces__srv__SerializedDeviceCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SerializedDeviceCommand messages.
/**
 * It calls
 * hos_interfaces__srv__SerializedDeviceCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SerializedDeviceCommand message array equality.
/**
...
/// Copy an array of srv/SerializedDeviceCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hos_interfaces__srv__SerializedDeviceCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hos_interfaces
...
/**
 * It calls
 * hos_interfaces__srv__SerializedDeviceCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hos_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hos_interfaces__srv__SerializedDeviceCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hos_interfaces
...
/**
 * It calls
 * hos_interfaces__srv__SerializedDeviceCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HOS_INTERFACES__SRV__DETAIL__SERIALIZED_DEVICE_COMMAND__FUNCTIONS_H_
