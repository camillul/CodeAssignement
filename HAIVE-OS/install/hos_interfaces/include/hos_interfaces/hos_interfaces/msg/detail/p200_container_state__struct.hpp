...
#ifndef HOS_INTERFACES__MSG__DETAIL__P200_CONTAINER_STATE__STRUCT_HPP_
#define HOS_INTERFACES__MSG__DETAIL__P200_CONTAINER_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__hos_interfaces__msg__P200ContainerState __attribute__((deprecated))
#else
# define DEPRECATED__hos_interfaces__msg__P200ContainerState __declspec(deprecated)
#endif
...
struct P200ContainerState_
{
  using Type = P200ContainerState_<ContainerAllocator>;

  explicit P200ContainerState_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit P200ContainerState_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    hos_interfaces::msg::P200ContainerState_<ContainerAllocator> *;
  using ConstRawPtr =
    const hos_interfaces::msg::P200ContainerState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      hos_interfaces::msg::P200ContainerState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__hos_interfaces__msg__P200ContainerState
    std::shared_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__hos_interfaces__msg__P200ContainerState
    std::shared_ptr<hos_interfaces::msg::P200ContainerState_<ContainerAllocator> const>
  ...
  bool operator==(const P200ContainerState_ & other) const
  {
...
using P200ContainerState =
  hos_interfaces::msg::P200ContainerState_<std::allocator<void>>;
...
#endif  // HOS_INTERFACES__MSG__DETAIL__P200_CONTAINER_STATE__STRUCT_HPP_
