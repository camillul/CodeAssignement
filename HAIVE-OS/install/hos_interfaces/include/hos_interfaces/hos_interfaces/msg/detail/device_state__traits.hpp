...
#ifndef HOS_INTERFACES__MSG__DETAIL__DEVICE_STATE__TRAITS_HPP_
#define HOS_INTERFACES__MSG__DETAIL__DEVICE_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const hos_interfaces::msg::DeviceState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hos_interfaces::msg::DeviceState & msg)
{
  return hos_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hos_interfaces::msg::DeviceState>()
{
  return "hos_interfaces::msg::DeviceState";
}

template<>
inline const char * name<hos_interfaces::msg::DeviceState>()
{
  return "hos_interfaces/msg/DeviceState";
}

template<>
struct has_fixed_size<hos_interfaces::msg::DeviceState>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<hos_interfaces::msg::DeviceState>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<hos_interfaces::msg::DeviceState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HOS_INTERFACES__MSG__DETAIL__DEVICE_STATE__TRAITS_HPP_
