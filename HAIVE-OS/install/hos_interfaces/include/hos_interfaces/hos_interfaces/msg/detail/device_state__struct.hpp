...
#ifndef HOS_INTERFACES__MSG__DETAIL__DEVICE_STATE__STRUCT_HPP_
#define HOS_INTERFACES__MSG__DETAIL__DEVICE_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__hos_interfaces__msg__DeviceState __attribute__((deprecated))
#else
# define DEPRECATED__hos_interfaces__msg__DeviceState __declspec(deprecated)
#endif
...
struct DeviceState_
{
  ...
  // pointer types
  using RawPtr =
    hos_interfaces::msg::DeviceState_<ContainerAllocator> *;
  using ConstRawPtr =
    const hos_interfaces::msg::DeviceState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      hos_interfaces::msg::DeviceState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__hos_interfaces__msg__DeviceState
    std::shared_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__hos_interfaces__msg__DeviceState
    std::shared_ptr<hos_interfaces::msg::DeviceState_<ContainerAllocator> const>
...
using DeviceState =
  hos_interfaces::msg::DeviceState_<std::allocator<void>>;
...
#endif  // HOS_INTERFACES__MSG__DETAIL__DEVICE_STATE__STRUCT_HPP_
