...
#ifndef HOS_INTERFACES__MSG__DETAIL__MAGNET_CONTAINER_STATE__TRAITS_HPP_
#define HOS_INTERFACES__MSG__DETAIL__MAGNET_CONTAINER_STATE__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const MagnetContainerState & msg,
  std::ostream & out)
{
  out << "{";
  // member: is_flipped
...
inline std::string to_yaml(const MagnetContainerState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const hos_interfaces::msg::MagnetContainerState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hos_interfaces::msg::MagnetContainerState & msg)
{
  return hos_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hos_interfaces::msg::MagnetContainerState>()
{
  return "hos_interfaces::msg::MagnetContainerState";
}

template<>
inline const char * name<hos_interfaces::msg::MagnetContainerState>()
{
  return "hos_interfaces/msg/MagnetContainerState";
}

template<>
struct has_fixed_size<hos_interfaces::msg::MagnetContainerState>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<hos_interfaces::msg::MagnetContainerState>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<hos_interfaces::msg::MagnetContainerState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HOS_INTERFACES__MSG__DETAIL__MAGNET_CONTAINER_STATE__TRAITS_HPP_
