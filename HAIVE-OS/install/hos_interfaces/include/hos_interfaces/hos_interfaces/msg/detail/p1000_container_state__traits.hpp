...
#ifndef HOS_INTERFACES__MSG__DETAIL__P1000_CONTAINER_STATE__TRAITS_HPP_
#define HOS_INTERFACES__MSG__DETAIL__P1000_CONTAINER_STATE__TRAITS_HPP_
...
inline std::string to_yaml(const P1000ContainerState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const hos_interfaces::msg::P1000ContainerState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hos_interfaces::msg::P1000ContainerState & msg)
{
  return hos_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<hos_interfaces::msg::P1000ContainerState>()
{
  return "hos_interfaces::msg::P1000ContainerState";
}

template<>
inline const char * name<hos_interfaces::msg::P1000ContainerState>()
{
  return "hos_interfaces/msg/P1000ContainerState";
}

template<>
struct has_fixed_size<hos_interfaces::msg::P1000ContainerState>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<hos_interfaces::msg::P1000ContainerState>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<hos_interfaces::msg::P1000ContainerState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // HOS_INTERFACES__MSG__DETAIL__P1000_CONTAINER_STATE__TRAITS_HPP_
