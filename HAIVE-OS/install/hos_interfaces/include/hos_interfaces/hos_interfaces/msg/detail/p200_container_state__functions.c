...
hos_interfaces__msg__P200ContainerState__init(hos_interfaces__msg__P200ContainerState * msg)
{
  ...
  if (!rosidl_runtime_c__uint16__Sequence__init(&msg->tips_availaible, 0)) {
    hos_interfaces__msg__P200ContainerState__fini(msg);
    return false;
  }
  // is_flipped
  // slot_position
...
hos_interfaces__msg__P200ContainerState__create()
{
  ...
  hos_interfaces__msg__P200ContainerState * msg = (hos_interfaces__msg__P200ContainerState *)allocator.allocate(sizeof(hos_interfaces__msg__P200ContainerState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hos_interfaces__msg__P200ContainerState));
  bool success = hos_interfaces__msg__P200ContainerState__init(msg);
  if (!success) {
...
hos_interfaces__msg__P200ContainerState__Sequence__init(hos_interfaces__msg__P200ContainerState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__msg__P200ContainerState * data = NULL;

  if (size) {
    data = (hos_interfaces__msg__P200ContainerState *)allocator.zero_allocate(size, sizeof(hos_interfaces__msg__P200ContainerState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hos_interfaces__msg__P200ContainerState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hos_interfaces__msg__P200ContainerState__fini(&data[i - 1]);
      }
...
hos_interfaces__msg__P200ContainerState__Sequence__fini(hos_interfaces__msg__P200ContainerState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hos_interfaces__msg__P200ContainerState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hos_interfaces__msg__P200ContainerState__Sequence * array = (hos_interfaces__msg__P200ContainerState__Sequence *)allocator.allocate(sizeof(hos_interfaces__msg__P200ContainerState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hos_interfaces__msg__P200ContainerState__Sequence__init(array, size);
  if (!success) {
...
hos_interfaces__msg__P200ContainerState__Sequence__destroy(hos_interfaces__msg__P200ContainerState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hos_interfaces__msg__P200ContainerState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hos_interfaces__msg__P200ContainerState__Sequence__are_equal(const hos_interfaces__msg__P200ContainerState__Sequence * lhs, const hos_interfaces__msg__P200ContainerState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hos_interfaces__msg__P200ContainerState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hos_interfaces__msg__P200ContainerState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hos_interfaces__msg__P200ContainerState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hos_interfaces__msg__P200ContainerState * data =
      (hos_interfaces__msg__P200ContainerState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hos_interfaces__msg__P200ContainerState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hos_interfaces__msg__P200ContainerState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hos_interfaces__msg__P200ContainerState__copy(
